...
export class StudentReportService {
  ...
  getDifficultyAnalytics(): Observable<Array<{examName:string; difficulty: 'basic'|'intermediate'|'advanced'; score?: number; avgScore?: number; attempts?: number }>> {
    const userId = this.getUserId();
    return this.http.get<Array<{ examName:string;difficulty: 'basic'|'intermediate'|'advanced'; score?: number; avgScore?: number; attempts?: number}>>(
